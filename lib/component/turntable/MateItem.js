...
class MateItem extends skynode_1.DomNode {
    ...
    this.append(
      (0, skynode_1.el)(
        ...
        (0, skynode_1.el)(
          ...
          (0, skynode_1.el)("span.id", `#${id}`),
          (0, skynode_1.el)("span.name", name)
        ),
        (0, skynode_1.el)(
          ".info",
        ...
        (0, skynode_1.el)(
          ".controller",
          (0, skynode_1.el)("a.claim-button", "받기", {
            click: async () => {
              await MatesListenersContract_1.default.claim(this.turntableId, [
                this.id,
              ]);
            },
          })
  ...
  async load() {
    const claimable = await MatesListenersContract_1.default.claimableOf(
      this.turntableId,
      this.id
    );
