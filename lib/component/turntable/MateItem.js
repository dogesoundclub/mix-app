...
class MateItem extends skydapp_browser_1.DomNode {
    constructor(view, turntableId, id, name) {
        ...
        this.append((0, skydapp_browser_1.el)(".content", (0, skydapp_browser_1.el)(".mate", { style: { backgroundImage: `url(https://storage.googleapis.com/dsc-mate/336/dscMate-${id}.png)` } }, (0, skydapp_browser_1.el)("span.id", `#${id}`), (0, skydapp_browser_1.el)("span.name", name)), (0, skydapp_browser_1.el)(".info", (0, skydapp_browser_1.el)("h5", (0, skydapp_browser_1.msg)("MINING_ITEM_TITLE")), this.mixAmount = (0, skydapp_browser_1.el)(".amount", "Loading...")), (0, skydapp_browser_1.el)(".controller", (0, skydapp_browser_1.el)("a.claim-button", "받기", {
            click: async () => {
