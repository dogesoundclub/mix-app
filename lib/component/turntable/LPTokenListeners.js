...
class LPTokenListeners extends skydapp_browser_1.DomNode {
    ...
    async load() {
        ...
        try {
            ...
            this.append((0, skydapp_browser_1.el)(".total-lp", `총 LP: ${CommonUtil_1.default.numberWithCommas(ethers_1.utils.formatEther(totalShares))}`), (0, skydapp_browser_1.el)(".apr", `APR: ${apr}%`));
        }
        catch (e) {
            console.error(e);
            this.append((0, skydapp_browser_1.el)(".total-lp", `총 LP: ${CommonUtil_1.default.numberWithCommas(ethers_1.utils.formatEther(totalShares))}`), (0, skydapp_browser_1.el)(".apr", "APR: 가격 정보를 불러오는데 실패했습니다."));
        }
        ...
        if (walletAddress !== undefined) {
            ...
            this.append((0, skydapp_browser_1.el)(".staking-lp", `내가 넣은 LP: ${CommonUtil_1.default.numberWithCommas(ethers_1.utils.formatEther(share))}`), (0, skydapp_browser_1.el)(".my-lp", `내가 가진 LP: ${CommonUtil_1.default.numberWithCommas(ethers_1.utils.formatEther(lpBalance))}`), (0, skydapp_browser_1.el)(".amount", `쌓인 MIX: ${CommonUtil_1.default.numberWithCommas(ethers_1.utils.formatEther(reward))}`), (0, skydapp_browser_1.el)("a", "LP 토큰 리스너 등록", {
                click: () => {
            ...
            }), (0, skydapp_browser_1.el)("a", "MIX 받기 허락", {
                click: async () => {
            ...
            }), (0, skydapp_browser_1.el)("p.warning", "* MIX 받기 허락을 먼저 수행하신 후, MIX 받기를 실행해주세요."));
        }
    }
}
