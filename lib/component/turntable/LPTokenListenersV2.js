...
class LPTokenListenersV2 extends skydapp_browser_1.DomNode {
    constructor(name, contract, turntableId, poolId) {
        super(".lp-token-listeners");
        this.contract = contract;
        this.turntableId = turntableId;
        this.poolId = poolId;
        this.append((0, skydapp_browser_1.el)("h4", name));
        this.load();
    }
    async load() {
        ...
        try {
            ...
            this.append((0, skydapp_browser_1.el)(".lp-container", (0, skydapp_browser_1.el)("p", `총 LP: ${CommonUtil_1.default.numberWithCommas(ethers_1.utils.formatEther(totalShares))}`), (0, skydapp_browser_1.el)("hr"), (0, skydapp_browser_1.el)("p", `추가 APR: +${apr}%`)));
        }
        catch (e) {
            console.error(e);
            this.append((0, skydapp_browser_1.el)(".lp-container", (0, skydapp_browser_1.el)("p", `총 LP: ${CommonUtil_1.default.numberWithCommas(ethers_1.utils.formatEther(totalShares))}`), (0, skydapp_browser_1.el)("hr"), (0, skydapp_browser_1.el)("p", "추가 APR: 가격 정보를 불러오는데 실패했습니다.")));
        }
        ...
        if (walletAddress !== undefined) {
            ...
            this.append((0, skydapp_browser_1.el)(".my-container", (0, skydapp_browser_1.el)("p", `내가 넣은 LP: ${CommonUtil_1.default.numberWithCommas(ethers_1.utils.formatEther(share))}`), (0, skydapp_browser_1.el)("hr"), (0, skydapp_browser_1.el)("p", `내가 가진 LP: ${CommonUtil_1.default.numberWithCommas(ethers_1.utils.formatEther(lpBalance))}`)), (0, skydapp_browser_1.el)(".interest-container", (0, skydapp_browser_1.el)("p", `쌓인 MIX: ${CommonUtil_1.default.numberWithCommas(ethers_1.utils.formatEther(mixReward))}`), (0, skydapp_browser_1.el)("hr"), (0, skydapp_browser_1.el)("p", `쌓인 KSP: ${CommonUtil_1.default.numberWithCommas(ethers_1.utils.formatEther(kspReward))}`), (0, skydapp_browser_1.el)("hr"), (0, skydapp_browser_1.el)("p", `쌓인 PUNK: ${CommonUtil_1.default.numberWithCommas(ethers_1.utils.formatEther(punkReward))}`)), (0, skydapp_browser_1.el)("a", "쌓인 수량 재계산", {
                click: async () => {
                    await this.contract.unlisten(this.turntableId, 0);
                    ViewUtil_1.default.waitTransactionAndRefresh();
                },
            }), (0, skydapp_browser_1.el)("a", "LP 토큰 리스너 등록", {
                click: () => {
                    new Prompt_1.default("LP 토큰 리스너 등록", "얼마만큼의 LP 토큰을 등록하시겠습니까?", "등록하기", async (amount) => {
                        const lp = ethers_1.utils.parseEther(amount);
                        await this.contract.listen(this.turntableId, lp);
                        ViewUtil_1.default.waitTransactionAndRefresh();
                    });
                },
            }), (0, skydapp_browser_1.el)("a", "LP 토큰 리스너 등록 취소", {
                click: () => {
                    new Prompt_1.default("LP 토큰 리스너 등록", "얼마만큼의 LP 토큰을 등록 취소하시겠습니까?", "등록 취소", async (amount) => {
                        const lp = ethers_1.utils.parseEther(amount);
                        await this.contract.unlisten(this.turntableId, lp);
                        ViewUtil_1.default.waitTransactionAndRefresh();
                    });
                },
            }), (0, skydapp_browser_1.el)("a", "MIX 받기", {
                click: async () => {
                    await this.contract.claim(this.turntableId, Config_1.default.contracts.Mix);
                    ViewUtil_1.default.waitTransactionAndRefresh();
                },
            }), (0, skydapp_browser_1.el)("a", "KSP 받기", {
                click: async () => {
                    await this.contract.claim(this.turntableId, Config_1.default.contracts.KSP);
                    ViewUtil_1.default.waitTransactionAndRefresh();
                },
            }), (0, skydapp_browser_1.el)("a", "PUNK 받기", {
                click: async () => {
