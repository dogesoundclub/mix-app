...
class LPTokenListenersV2 extends skynode_1.DomNode {
    ...
    async load() {
        ...
        try {
            ...
            this.append((0, skynode_1.el)(".lp-container", (0, skynode_1.el)("p", `총 LP: ${CommonUtil_1.default.numberWithCommas(ethers_1.utils.formatEther(totalShares))}`), (0, skynode_1.el)("hr"), (0, skynode_1.el)("p", `추가 APR: +${apr}%`)));
        }
        catch (e) {
            console.error(e);
            this.append((0, skynode_1.el)(".lp-container", (0, skynode_1.el)("p", `총 LP: ${CommonUtil_1.default.numberWithCommas(ethers_1.utils.formatEther(totalShares))}`), (0, skynode_1.el)("hr"), (0, skynode_1.el)("p", "추가 APR: 가격 정보를 불러오는데 실패했습니다.")));
        }
        ...
        if (walletAddress !== undefined) {
            ...
            this.append((0, skynode_1.el)(".my-container", (0, skynode_1.el)("p", `내가 넣은 LP: ${CommonUtil_1.default.numberWithCommas(ethers_1.utils.formatEther(share))}`), (0, skynode_1.el)("hr"), (0, skynode_1.el)("p", `내가 가진 LP: ${CommonUtil_1.default.numberWithCommas(ethers_1.utils.formatEther(lpBalance))}`)), (0, skynode_1.el)(".interest-container", (0, skynode_1.el)("p", `쌓인 MIX: ${CommonUtil_1.default.numberWithCommas(ethers_1.utils.formatEther(mixReward))}`), (0, skynode_1.el)("hr"), (0, skynode_1.el)("p", `쌓인 KSP: ${CommonUtil_1.default.numberWithCommas(ethers_1.utils.formatEther(kspReward))}`), (0, skynode_1.el)("hr"), (0, skynode_1.el)("p", `쌓인 PUNK: ${CommonUtil_1.default.numberWithCommas(ethers_1.utils.formatEther(punkReward))}`)), (0, skynode_1.el)("a", "쌓인 수량 재계산", {
                click: async () => {
