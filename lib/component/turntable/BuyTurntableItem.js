...
class BuyTurntableItem extends skydapp_browser_1.DomNode {
    constructor(typeId) {
        super(".buy-turntable-item");
        this.typeId = typeId;
        const turntable = turntables_json_1.default[typeId];
        this.append((0, skydapp_browser_1.el)("h4", turntable.name, { style: { color: turntable.color } }), (0, skydapp_browser_1.el)("img", { src: turntable.img }), (0, skydapp_browser_1.el)(".volume", `Volume: ${CommonUtil_1.default.numberWithCommas(String(turntable.volume))}`), (0, skydapp_browser_1.el)(".price", `Price: ${CommonUtil_1.default.numberWithCommas(String(turntable.price))} MIX`), (0, skydapp_browser_1.el)(".lifetime", `Lifetime: ${CommonUtil_1.default.numberWithCommas(String(turntable.lifetime))} Blocks`), this.apr = (0, skydapp_browser_1.el)(".apr", `APR: Loading...`), (0, skydapp_browser_1.el)("button", "구매하기", {
            click: async () => {
                new Alert_1.default("구매 불가", "MIX 백서 v2 실행으로 인해 턴테이블 추가 생성은 불가능합니다.");
            },
        }));
        this.loadAPR();
    }
