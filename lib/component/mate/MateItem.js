...
class MateItem extends skydapp_browser_1.DomNode {
    constructor(list, id, name, selectable, showingRarity) {
        ...
        this.append((0, skydapp_browser_1.el)("span.id", `#${id}`));
        if (showingRarity === true) {
            (0, skydapp_browser_1.el)("span.score", CommonUtil_1.default.numberWithCommas(String(rarity_json_1.default.scores[id]))).appendTo(this);
        }
        else if (selectable === true) {
            if (list.votedMates.includes(id) !== true) {
                this.checkbox = (0, skydapp_browser_1.el)("input", {
                    type: "checkbox",
            ...
            (0, skydapp_browser_1.el)("span.name", name).appendTo(this);
        }
        this.onDom("click", () => {
            if (selectable === true) {
                if (this.checkbox !== undefined) {
