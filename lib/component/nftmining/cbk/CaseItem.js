...
class CaseItem extends skydapp_browser_1.DomNode {
    constructor(tab, id) {
        super(".case-item");
        this.tab = tab;
        this.id = id;
        this.claimable = ethers_1.BigNumber.from(0);
        this.append((0, skydapp_browser_1.el)(".content", (0, skydapp_browser_1.el)("img", { src: `https://storage.googleapis.com/cbk-nft/v2/${id}.png`, alt: `cbk-${id}` }), (0, skydapp_browser_1.el)(".info", (0, skydapp_browser_1.el)("h5", (0, skydapp_browser_1.msg)("MINING_ITEM_TITLE")), this.mixAmount = (0, skydapp_browser_1.el)(".amount", "Loading...")), (0, skydapp_browser_1.el)(".controller", (0, skydapp_browser_1.el)("button.claim-button", (0, skydapp_browser_1.msg)("MINING_ITEM_BUTTON"), {
            click: async () => {
                ...
                if (owner !== undefined) {
                    ...
                    if (balance.lt(fee)) {
                        new Confirm_1.default((0, skydapp_browser_1.msg)("MINING_ITEM_CONFIRM_TITLE1"), (0, skydapp_browser_1.msg)("MINING_ITEM_CONFIRM_DESC1"), (0, skydapp_browser_1.msg)("MINING_ITEM_CONFIRM_BUTTON1"), () => {
