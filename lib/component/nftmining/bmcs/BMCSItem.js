...
class BMCSItem extends skydapp_browser_1.DomNode {
    constructor(tab, id, name) {
        ...
        this.append((0, skydapp_browser_1.el)(".content", this.image = (0, skydapp_browser_1.el)("img", { alt: `bias-${id}` }), (0, skydapp_browser_1.el)(".info", (0, skydapp_browser_1.el)("h5", (0, skydapp_browser_1.msg)("MINING_ITEM_TITLE")), this.mixAmount = (0, skydapp_browser_1.el)(".amount", "Loading...")), (0, skydapp_browser_1.el)(".controller", (0, skydapp_browser_1.el)("button.claim-button", (0, skydapp_browser_1.msg)("MINING_ITEM_BUTTON"), {
            click: async () => {
