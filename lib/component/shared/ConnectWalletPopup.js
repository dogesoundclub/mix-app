...
class ConnectWalletPopup extends skynode_1.Popup {
  constructor(callback) {
    ...
    this.append(
      (this.content = (0, skynode_1.el)(
        ".connect-wallet-popup",
        (0, skynode_1.el)("h2", "클레이튼 지갑 연결"),
        (0, skynode_1.el)(
          "p",
          "Klubs는 클레이튼 블록체인과의 연결이 필요합니다. 카이카스 혹은 카카오톡 클립에서 연결해주시기 바랍니다."
        ),
        (0, skynode_1.el)(
          ".button-container",
          (0, skynode_1.el)(
            "button.connect-kaikas-button",
            (0, skynode_1.el)("img", { src: "/images/shared/logo/kaikas.svg" }),
            "카이카스 설치",
            {
          ...
          (0, skynode_1.el)(
            "button.connect-klip-button",
            (0, skynode_1.el)("img", { src: "/images/shared/logo/klip.svg" }),
            "카카오톡 클립으로 연결",
            {
              click: async () => {
