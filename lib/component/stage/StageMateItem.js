...
class StageMateItem extends skydapp_browser_1.DomNode {
    constructor(stage, id, mix, name, currentBlock, isDancing) {
        ...
        this.append(this.dancingDisplay = (0, skydapp_browser_1.el)(".dancing-container"), isDancing === true ? (0, skydapp_browser_1.el)(".progress-container", {
            click: () => {
                ...
                if (this.checkbox.domElement.checked) {
                    ...
                    if (isDancing === true) {
                        stage.deselectStaking(MateContract_1.default.address, id);
                    }
                    else {
                        stage.deselectUnstaking(MateContract_1.default.address, id);
                    }
                }
                else {
                    this.imageDisplay.style({
                    ...
                    if (isDancing === true) {
                        stage.selectStaking(MateContract_1.default.address, id);
                    }
                    else {
                        stage.selectUnstaking(MateContract_1.default.address, id);
                    }
                }
            },
        ...
        }), (0, skydapp_browser_1.el)(".checkbox-container", this.checkbox = (0, skydapp_browser_1.el)("input", {
    ...
    async loadBar() {
        this.stakingBlock = (await MixStakingContract_1.default.stakingBlocks(MateContract_1.default.address, this.id)).toNumber();
        this.returnMixTimes = (await MixStakingContract_1.default.returnMixTimes(MateContract_1.default.address, this.id)).toNumber();
        const percent = (this.currentBlock - this.stakingBlock) / this.returnMixTimes * 100;
