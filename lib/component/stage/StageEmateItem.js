...
class StageEmateItem extends skydapp_browser_1.DomNode {
    constructor(id, mix, name, isDancing) {
        ...
        this.append(this.dancingDisplay = (0, skydapp_browser_1.el)(".dancing-container"), (0, skydapp_browser_1.el)(".progress-container", (0, skydapp_browser_1.el)(".progress", this.bar = (0, skydapp_browser_1.el)(".bar")), (0, skydapp_browser_1.el)(".title", "MIX 수령까지 남은 Block"), (0, skydapp_browser_1.el)("p", "1,296,000")), (0, skydapp_browser_1.el)("img", { src: `https://storage.googleapis.com/emates/klaytn/Emates-${id}.png`, alt: "mate-mock" }), (0, skydapp_browser_1.el)(".checkbox-container", this.checkbox = (0, skydapp_browser_1.el)("input", { type: "checkbox", id: `mate${id}` }, {
            change: () => {
