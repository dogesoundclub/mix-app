...
const Stage_1 = __importDefault(require("./view/Stage"));
(async () => {
    ...
    skydapp_common_1.SkyRouter.route("governance/{proposalId}", Proposal_1.default, [
        "governance/propose",
    ]);
    skydapp_common_1.SkyRouter.route("governance/propose", Propose_1.default);
    skydapp_common_1.SkyRouter.route("mining", Mining_1.default);
    skydapp_common_1.SkyRouter.route("mining/v1", MiningV1_1.default);
    skydapp_common_1.SkyRouter.route("burn", Burn_1.default);
    skydapp_common_1.SkyRouter.route("booth", Booth_1.default);
    skydapp_common_1.SkyRouter.route("turntable", Turntable_1.default);
    skydapp_common_1.SkyRouter.route("turntable/buy", BuyTurntable_1.default);
    skydapp_common_1.SkyRouter.route("turntable/{id}", Detail_1.default, ["turntable/buy"]);
    skydapp_common_1.SkyRouter.route("turntable/{id}/update", Update_1.default);
    skydapp_common_1.SkyRouter.route("turntable/{id}/addmates", AddMates_1.default);
    skydapp_common_1.SkyRouter.route("turntable/{id}/removemates", RemoveMates_1.default);
    skydapp_common_1.SkyRouter.route("turntable/{id}/miningmates", MiningMates_1.default);
    skydapp_common_1.SkyRouter.route("turntable/{id}/mateholders", MateHolders_1.default);
    skydapp_common_1.SkyRouter.route("stage", Stage_1.default);
