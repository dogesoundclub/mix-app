...
class Proposal {
    ...
    async load(proposalId) {
        ...
        this.container.append((0, skynode_1.el)("h1", proposal.title), (0, skynode_1.el)(".proposer-container", (0, skynode_1.el)("span.proposer", "제안자"), (0, skynode_1.el)("span.address", proposal.proposer)), (0, skynode_1.el)(".content", (0, skynode_1.el)("h6", "기간"), revoted === true ?
            (0, skynode_1.el)("p", `재투표 종료: ${TimeFormatter_1.default.fromNow(new Date(proposal.startRevoteTime + Constants_1.default.REVOTE_PERIOD))}`) :
            (0, skynode_1.el)("p", `투표 종료: ${TimeFormatter_1.default.fromNow(new Date(proposal.passTime + Constants_1.default.VOTE_PERIOD))}`), (0, skynode_1.el)("h6", "요약"), (0, skynode_1.el)("p", proposal.summary), (0, skynode_1.el)("hr"), (0, skynode_1.el)("h6", "본문"), contentDisplay = (0, skynode_1.el)("p.markdown-body"), (0, skynode_1.el)("hr"), (0, skynode_1.el)("h6", "비고"), noteDisplay = (0, skynode_1.el)("p.markdown-body"), (0, skynode_1.el)("hr")), (0, skynode_1.el)(".vote-container", (0, skynode_1.el)(".assets", (0, skynode_1.el)("h2", "총 투표자산"), revoted === true ? new AssetsDisplay_1.default(proposal.revoterAssets) : new AssetsDisplay_1.default(proposal.voterAssets)), (0, skynode_1.el)(".options-wrapper", (0, skynode_1.el)("header", (0, skynode_1.el)("h2", "투표 목록"), (0, skynode_1.el)("p", "후보들 중에 마음에 드는 후보가 없는 경우 다른 후보를 등록할 수 있습니다.")), (0, skynode_1.el)(".options", (0, skynode_1.el)(".list", (0, skynode_1.el)("header", (0, skynode_1.el)(".title", "후보"), (0, skynode_1.el)(".voters", "투표자"), (0, skynode_1.el)(".percent", "가중치"), (0, skynode_1.el)(".controller", "투표하기")), optionList = (0, skynode_1.el)("ul")), revoted === true ? undefined : (0, skynode_1.el)(".caption-container"), revoted === true || proposal.passed !== true ? undefined : (0, skynode_1.el)("button", "후보 추가", {
            click: () => {
