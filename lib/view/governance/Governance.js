...
class Governance {
    constructor() {
        ...
        Layout_1.default.current.content.append(this.container = (0, skynode_1.el)(".governance-view", (0, skynode_1.el)("section", (0, skynode_1.el)("h1", "MIX 거버넌스"), (0, skynode_1.el)("p", "MIX를 위한 제안을 적극 환영합니다"), (0, skynode_1.el)(".top-nav", (0, skynode_1.el)("button", "제안 생성", {
            click: () => new Alert_1.default("MIX 백서 v2 실행이 완료될 때 까지 거버넌스 제안 생성이 불가능합니다."),
