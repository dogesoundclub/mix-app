...
class Booth {
    constructor() {
        ...
        Layout_1.default.current.content.append(this.container = (0, skynode_1.el)(".booth-view", (0, skynode_1.el)("section", (0, skynode_1.el)("section", (0, skynode_1.el)(".content", (0, skynode_1.el)(".title", "1 MIXSET"), this.priceDisplay = (0, skynode_1.el)("span", new Loading_1.default()), (0, skynode_1.el)("span", " MIX")), (0, skynode_1.el)(".grid-container", (0, skynode_1.el)(".content", (0, skynode_1.el)(".title", "지난 24시간 동안의 APR"), this.aprDisplay = (0, skynode_1.el)("span.bold", new Loading_1.default()), (0, skynode_1.el)("span", " %")), (0, skynode_1.el)(".content", (0, skynode_1.el)(".title", "예치된 총 MIX"), this.totalBalanceDisplay = (0, skynode_1.el)("span.bold", new Loading_1.default()), (0, skynode_1.el)("span", " MIX")), (0, skynode_1.el)(".content", (0, skynode_1.el)(".title", "지난 24시간 동안 소각된 MIX"), this.burn24Display = (0, skynode_1.el)("span.bold", new Loading_1.default()), (0, skynode_1.el)("span", " MIX")), (0, skynode_1.el)(".content", (0, skynode_1.el)(".title", "지난 24시간 동안 분배된 MIX"), this.reward24Display = (0, skynode_1.el)("span.bold", new Loading_1.default()), (0, skynode_1.el)("span", " MIX")))), (0, skynode_1.el)("hr"), (0, skynode_1.el)("section.staking", (0, skynode_1.el)("h2", "MIX 스테이킹"), (0, skynode_1.el)("p", "MIX가 소각될 때 마다 소각량의 0.3%가 부스에 대한 지분에 따라 분배됩니다."), (0, skynode_1.el)(".form", this.stakeInput = (0, skynode_1.el)("input", { placeholder: "예치할 액수를 넣어주세요." }), (0, skynode_1.el)("button", "예치하기", {
            click: async () => {
                await BoothContract_1.default.stake(ethers_1.utils.parseEther(this.stakeInput.domElement.value));
                ViewUtil_1.default.waitTransactionAndRefresh();
            },
        }), (0, skynode_1.el)(".container", (0, skynode_1.el)(".caption", (0, skynode_1.el)("label", "MIX: "), this.balanceDisplay = (0, skynode_1.el)("span", new Loading_1.default())), (0, skynode_1.el)("button.max-btn", "최대 수량", {
            click: async () => {
        ...
        }))), (0, skynode_1.el)(".warning", "예치 시에는 2번의 트랜잭션이 발생합니다. 한번은 토큰 사용 허락을 위한 것이며, 다른 하나는 실제 예치를 위한 것입니다."), (0, skynode_1.el)("h2", "MIX 스테이킹 해제"), (0, skynode_1.el)(".form", this.unstakeInput = (0, skynode_1.el)("input", { placeholder: "예치할 액수를 넣어주세요." }), (0, skynode_1.el)("button", "해제하기", {
            click: async () => {
                await BoothContract_1.default.unstake(ethers_1.utils.parseEther(this.unstakeInput.domElement.value));
                ViewUtil_1.default.waitTransactionAndRefresh();
            },
        }), (0, skynode_1.el)(".container", (0, skynode_1.el)(".caption", (0, skynode_1.el)("label", "MIXSET: "), this.mixsetDisplay = (0, skynode_1.el)("span", new Loading_1.default())), (0, skynode_1.el)("button.max-btn", "최대 수량", {
            click: async () => {
                const walletAddress = await Wallet_1.default.loadAddress();
                if (walletAddress !== undefined) {
