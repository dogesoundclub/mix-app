    ...
    async load() {
        ...
        if (walletAddress !== undefined) {
            ...
            for (const stakingMate of this.stakingMates) {
                this.onStageMates.append(new StageMateItem_1.default(stakingMate, 300, "Undefined", true));
            }
            for (const stakingEmate of this.stakingEmates) {
                this.onStageMates.append(new StageEmateItem_1.default(stakingEmate, 300, "Undefined", true));
            }
            for (const stakingBmcs of this.stakingBmcss) {
                this.onStageMates.append(new StageBmcsItem_1.default(stakingBmcs, 300, "Undefined", true));
            }
            for (const unstakingMate of this.unstakingMates) {
                this.offStageMates.append(new StageMateItem_1.default(unstakingMate, 300, "Undefined", false));
            }
            for (const unstakingEmate of this.unstakingEmates) {
                this.offStageMates.append(new StageEmateItem_1.default(unstakingEmate, 300, "Undefined", false));
            }
            for (const unstakingBmcs of this.unstakingBmcss) {
                this.offStageMates.append(new StageBmcsItem_1.default(unstakingBmcs, 300, "Undefined", false));
            }
        }
    }
    close() {
