  ...
  constructor(params) {
    ...
    Layout_1.default.current.content.append(
      (this.container = (0, skynode_1.el)(
        ...
        (0, skynode_1.el)("h1", "턴테이블의 메이트 홀더들"),
        ...
        (0, skynode_1.el)(
          ...
          (0, skynode_1.el)(
            ...
            (0, skynode_1.el)(
              "tr",
              (0, skynode_1.el)("th", "홀더 주소"),
              (0, skynode_1.el)("th", "리스너로 등록한 메이트 개수")
            )
          ),
    ...
    if (walletAddress !== undefined) {
      ...
      for (const [holder, mates] of entries) {
        this.list.append(
          (0, skynode_1.el)(
            "tr.holder-item",
            (0, skynode_1.el)("td.holder", holder),
            (0, skynode_1.el)("td.mates", String(mates))
          )
        );
      }
    } else {
