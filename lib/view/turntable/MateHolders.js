...
class MateHolders {
    constructor(params) {
        ...
        Layout_1.default.current.content.append(this.container = (0, skydapp_browser_1.el)(".turntable-mate-holders-view", (0, skydapp_browser_1.el)("h1", "턴테이블의 메이트 홀더들"), (0, skydapp_browser_1.el)("a.back-button", "< 뒤로가기", {
            click: () => ViewUtil_1.default.go(`/turntable/${turntableId}`),
        }), (0, skydapp_browser_1.el)("table", (0, skydapp_browser_1.el)("thead", (0, skydapp_browser_1.el)("tr", (0, skydapp_browser_1.el)("th", "홀더 주소"), (0, skydapp_browser_1.el)("th", "리스너로 등록한 메이트 개수"))), this.list = (0, skydapp_browser_1.el)("tbody.mate-list", new Loading_1.default()))));
    ...
    async load(turntableId) {
        ...
        if (walletAddress !== undefined) {
            ...
            for (const [holder, mates] of entries) {
                this.list.append((0, skydapp_browser_1.el)("tr.holder-item", (0, skydapp_browser_1.el)("td.holder", holder), (0, skydapp_browser_1.el)("td.mates", String(mates))));
            }
        }
        else {
            this.list.empty();
