...
class AddMates {
    constructor(params) {
        ...
        Layout_1.default.current.content.append(this.container = (0, skydapp_browser_1.el)(".add-mates-to-turntable-view", (0, skydapp_browser_1.el)("h1", "턴테이블에 메이트 등록하기"), (0, skydapp_browser_1.el)("p", "해당 턴테이블에 리스너로 등록할 메이트를 선택해주시기 바랍니다."), this.mateRewardInfo = (0, skydapp_browser_1.el)("p.mate-reward-info"), this.selectedMates = (0, skydapp_browser_1.el)(".selected-mates", "선택된 메이트 갯수 : {count}개".replace(/{count}/, String(0))), (0, skydapp_browser_1.el)(".button-container", (0, skydapp_browser_1.el)("a", "▶ 최대로 선택하기", {
            click: () => this.mateList.maxSelect(),
        })), (0, skydapp_browser_1.el)(".button-container", (0, skydapp_browser_1.el)("a", "▶ 전체 선택 해제", {
            click: () => this.mateList.deselect(),
        })), this.mateList = new MateList_1.default(true, false), (0, skydapp_browser_1.el)("button.submit-button", "메이트 등록", {
            click: async () => {
