...
class MiningMates {
    constructor(params) {
        ...
        Layout_1.default.current.content.append(this.container = (0, skydapp_browser_1.el)(".mining-mates-from-turntable-view", (0, skydapp_browser_1.el)("h1", "턴테이블의 메이트로부터 채굴하기"), (0, skydapp_browser_1.el)("header", (0, skydapp_browser_1.el)(".total-mix", (0, skydapp_browser_1.el)("h4", (0, skydapp_browser_1.msg)("MINING_TAB_TITLE")), this.totalMixDisplay = (0, skydapp_browser_1.el)("span", "Loading...")), (0, skydapp_browser_1.el)("button.take-all-button", (0, skydapp_browser_1.msg)("MINING_TAB_BUTTON"), {
            click: async () => {
