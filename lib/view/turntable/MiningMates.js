...
class MiningMates {
    constructor(params) {
        ...
        Layout_1.default.current.content.append(this.container = (0, skynode_1.el)(".mining-mates-from-turntable-view", (0, skynode_1.el)("h1", "턴테이블의 메이트로부터 채굴하기"), (0, skynode_1.el)("header", (0, skynode_1.el)(".total-mix", (0, skynode_1.el)("h4", "쌓인 총 MIX"), this.totalMixDisplay = (0, skynode_1.el)("span", "Loading...")), (0, skynode_1.el)("button.take-all-button", "한꺼번에 받기", {
            click: async () => {
