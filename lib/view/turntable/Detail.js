    ...
    async loadInfo(turntableId) {
        ...
        if (turntable.owner === ethers_1.constants.AddressZero) {
            ...
            if (turntable.owner === walletAddress) {
                this.controller.empty().append((0, skydapp_browser_1.el)("button.update-button", (0, skydapp_browser_1.msg)("TURNTABLE_DETAIL_BUTTON6"), { click: () => ViewUtil_1.default.go(`/turntable/${turntableId}/update`) }));
