  ...
  constructor() {
    ...
    Layout_1.default.current.content.append(
      (this.container = (0, skynode_1.el)(
        ...
        (0, skynode_1.el)(
          "section",
          (0, skynode_1.el)("img", { src: "/images/shared/logo/mix.svg" }),
          (0, skynode_1.el)("h1", "믹스 소각"),
          (0, skynode_1.el)(
            "p",
            "MIX가 소각될 때 마다 소각량의 0.3%가 부스에 대한 지분에 따라 분배됩니다."
          ),
          (this.burnInput = (0, skynode_1.el)("input", {
            placeholder: "소각할 액수를 넣어주세요",
          })),
          (0, skynode_1.el)("button", "소각하기", {
            click: async () => {
              await MixContract_1.default.burn(
                ethers_1.utils.parseEther(this.burnInput.domElement.value)
              );
            ...
            (0, skynode_1.el)("button.max-btn", "최대 수량", {
              click: async () => {
                ...
                if (walletAddress !== undefined) {
                  ...
                  this.burnInput.domElement.value =
          ...
          (0, skynode_1.el)(
            "p.warning",
            "예치 시에는 2번의 트랜잭션이 발생합니다. 한번은 토큰 사용 허락을 위한 것이며,\n다른 하나는 실제 예치를 위한 것입니다."
          )
        )
      ))
    );
  ...
  async loadBalance() {
    ...
    if (walletAddress !== undefined) {
      ...
      this.balanceDisplay
        .empty()
        .appendText(
          `MIX: ${CommonUtil_1.default.numberWithCommas(
            ethers_1.utils.formatEther(balance)
          )}`
        );
    }
