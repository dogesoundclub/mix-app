...
export default class Home implements View {
    ...
    private async loadPrice() {
        ...
        if (this.container.deleted !== true) {
            this.burnableDisplay.empty().appendText(`${CommonUtil.numberWithCommas(utils.formatEther(burnable))} MIX`);
            this.poolDisplay.empty().appendText(`${CommonUtil.numberWithCommas(utils.formatEther(totalSupply))} MIX`);
        }
    }
